...
hl.bind("SUPER + SHIFT + 6", hl.dsp.global("quickshell:cheatsheetToggle"), { description = "Shell: Toggle cheatsheet" })
...
hl.bind("SUPER + B", hl.dsp.global("quickshell:barToggle"), { description = "Shell: Toggle bar" })
